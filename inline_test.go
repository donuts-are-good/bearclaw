...
func TestRelAttrLink(t *testing.T) {
	...
	nofollownoreferrerTests := []string{
		"[foo](http://bar.com/foo/)\n",
	...
	nofollownoreferrernoopenerTests := []string{
		"[foo](http://bar.com/foo/)\n",
